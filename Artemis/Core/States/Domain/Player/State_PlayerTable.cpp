...
{ 
	return m_HasMapChanged.load(); 
}

void State_PlayerTable::SetMapChanged(bool value) 
{ 
	m_HasMapChanged.store(value); 
}

uintptr_t State_PlayerTable::GetPlayerTableBase() const 
{ 
	return m_PlayerTableBase.load(); 
}

void State_PlayerTable::SetPlayerTableBase(uintptr_t pointer) 
{ 
