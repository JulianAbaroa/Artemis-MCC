...
void State_MemoryScanner::SetDelayMs(int ms) 
{ 
    m_DelayMs = ms; 
}

void State_MemoryScanner::SetWaitingForKey(bool w) 
{ 
    m_WaitingForKey = w; 
}

void State_MemoryScanner::SetScanning(bool s) 
{ 
    m_Scanning = s; 
}
...
const ScanSession& State_MemoryScanner::GetSession() const 
{ 
    return m_Session; 
}

const ScanFilter& State_MemoryScanner::GetFilter() const 
{ 
    return m_Session.Filter; 
}

int  State_MemoryScanner::GetDelayMs() const 
{ 
    return m_DelayMs; 
}

bool State_MemoryScanner::IsWaitingForKey() const 
{ 
    return m_WaitingForKey; 
}

bool State_MemoryScanner::IsScanning() const 
{ 
    return m_Scanning; 
}