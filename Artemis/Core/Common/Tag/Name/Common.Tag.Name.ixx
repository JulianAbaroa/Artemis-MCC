export module Common.Tag.Name;

import std;

export namespace Common::Tag::Name
{
	namespace Biped
	{
		...
		constexpr bool IsSpartan(const std::string& tag)
		{
			return tag == Spartan;
		}

		constexpr bool IsElite(const std::string& tag)
		{
			return tag == Elite;
		}
	}
	...
	namespace ArmorAbility
	{
		...
		constexpr bool IsArmorAbility(const std::string& tag)
		{
	...
	namespace Ammo
	{
		...
		constexpr bool IsAmmo(const std::string& tag)
		{
	...
	namespace Powerup
	{
		...
		constexpr bool IsPowerup(const std::string& tag)
		{
	...
	namespace Spawn
	{
		...
		constexpr bool IsSpawn(const std::string& tag)
		{
			return tag == InvisibleRespawnPoint || tag == InitialSpawnPoint ||
				tag == RespawnPoint;
		}

		constexpr bool IsInitialSpawn(const std::string& tag)
		{
			return tag == InitialSpawnPoint;
		}

		constexpr bool IsRespawn(const std::string& tag)
		{
			return tag == RespawnPoint;
		}

		constexpr bool IsInvisibleSpawn(const std::string& tag)
		{
	...
	namespace Boundary
	{
		...
		constexpr bool IsBoundary(const std::string& tag)
		{
	...
	namespace Explosive
	{
		...
		constexpr bool IsExplosive(const std::string& tag)
		{
	...
	namespace Lift
	{
		...
		constexpr bool IsLift(const std::string& tag)
		{
		...
		constexpr bool IsDefault(const std::string& tag)
		{
			return tag == ManCannon || tag == ManCannonMCC ||
				tag == GravityLift || tag == ForerunnerGravityLift;
		}

		constexpr bool IsHeavy(const std::string& tag)
		{
			return tag == ManCannonHeavy || tag == ManCannonHeavyMCC ||
				tag == ManCannonHumanMCC || tag == ForerunnerGravityLiftTall;
		}

		constexpr bool IsLight(const std::string& tag)
		{
		...
		constexpr bool IsCurved(const std::string& tag)
		{
			return tag == ManCannon || tag == ManCannonHeavy ||
		...
		constexpr bool IsVertical(const std::string tag)
		{
	...
	namespace Objective
	{
		...
		constexpr bool IsObjectiveSpawn(const std::string& tag)
		{
			return tag == FlagStand || tag == CapturePlate;
		}

		constexpr bool IsObjectiveZone(const std::string& tag)
		{
			return tag == HillMarker;
		}

		constexpr bool IsObjective(const std::string& tag)
		{
	...
	namespace Shield
	{
		...
		constexpr bool IsShieldDoor(const std::string& tag)
		{
			return tag == ShieldDoorSmall || tag == ShieldDoorMedium ||
				tag == ShieldDoorLarge;
		}

		constexpr bool IsPortableShield(const std::string& tag)
		{
	...
	namespace Teleport
	{
		constexpr const char* TeleportSender = "objects\\levels\\forge\\ff_teleporter_sender\\ff_teleporter_sender";
		constexpr const char* TeleportReceiver = "objects\\levels\\forge\\ff_teleporter_receiver\\ff_teleporter_receiver";
		constexpr const char* TeleportTwoWay = "objects\\levels\\forge\\ff_teleporter_2_way\\ff_teleporter_2_way";

		constexpr bool IsTeleport(const std::string& tag)
		{
			return tag == TeleportSender || tag == TeleportReceiver ||
				tag == TeleportTwoWay;
		}

		constexpr bool IsReceiver(const std::string& tag)
		{
			return tag == TeleportReceiver;
		}

		constexpr bool IsSender(const std::string& tag)
		{
			return tag == TeleportSender;
		}

		constexpr bool IsTwoWay(const std::string& tag)
		{
			return tag == TeleportTwoWay;
		}
	}
	...
	namespace Weapon
	{
		...
		constexpr const char* RocketLauncher = "objects\\weapons\\support_high\\rocket_launcher\\rocket_launcher";
		...
		constexpr const char* VehicleMountedMachinegun = "objects\\vehicles\\human\\turrets\\machinegun\\machinegun";
		...
		constexpr const char* VehicleMountedPlasmaTurret = "objects\\vehicles\\covenant\\turrets\\plasma_turret\\plasma_turret_mounted";
		...
		constexpr bool IsWeapon(const std::string& tag)
		{
		...
		constexpr bool IsGrenade(const std::string& tag)
		{
	...
	namespace Vehicle
	{
		...
		constexpr bool HasBoost(const std::string& tag)
		{
	...
	namespace Palletes
	{
		...
		constexpr bool IsPallete(const std::string& tag)
		{
	...
	namespace ControlDevice
	{
		...
		constexpr bool IsHealthStation(const std::string& tag)
		{
	...
	namespace SkyBox
	{
		...
		constexpr bool IsSkyBox(const std::string& tag)
		{
