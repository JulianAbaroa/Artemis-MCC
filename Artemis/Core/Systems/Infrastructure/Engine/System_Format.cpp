...
std::string System_Format::ToTimestamp(float totalSeconds)
{
...
std::string System_Format::WStringToString(const std::wstring& wstr) 
{
...
std::wstring System_Format::StringToWString(const std::string& str) 
{
...
const char* System_Format::GetEventClassName(EventClass eventClass)
{
    switch (eventClass)
    {
...
std::string System_Format::EventTypeToString(EventType type) 
{
    switch (type) 
    {
    // Server types
