...
SbspGeometry System_SbspBuilder::Build(
    const SbspObject& sbsp, int32_t sbspIndex)
{
    SbspGeometry out;
...
void System_SbspBuilder::BuildWorldBounds(const SbspObject& sbsp, SbspGeometry& out)
{
...
void System_SbspBuilder::BuildPortals(const SbspObject& sbsp, SbspGeometry& out)
{
...
void System_SbspBuilder::BuildClusters(const SbspObject& sbsp, SbspGeometry& out)
{
...
void System_SbspBuilder::BuildClusterAdjacency(const SbspObject& sbsp, SbspGeometry& out)
{
...
void System_SbspBuilder::BuildInstancedGeometry(const SbspObject& sbsp, SbspGeometry& out)
{
...
void System_SbspBuilder::BuildCollisionMaterials(const SbspObject& sbsp, SbspGeometry& out)
{
...
void System_SbspBuilder::BuildMarkers(const SbspObject& sbsp, SbspGeometry& out)
{
...
SbspVec3 System_SbspBuilder::MakeVec3(const Vec3& v)
{ 
    return { v.X, v.Y, v.Z }; 
}

SbspVec4 System_SbspBuilder::MakeVec4(const Vec4& v) 
{ 
    return { v.X, v.Y, v.Z, v.W }; 
}

SbspVec3 System_SbspBuilder::RangeFCenter(const RangeF& x, const RangeF& y, const RangeF& z)
{
    return
    {
