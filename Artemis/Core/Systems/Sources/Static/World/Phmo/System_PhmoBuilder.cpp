...
void System_PhmoBuilder::BuildRigidBodies(
    const PhmoObject& phmo, PhmoGeometry& out)
{
...
bool System_PhmoBuilder::ResolvePrimitive(
    const PhmoObject& phmo, uint16_t shapeType,
    int16_t shapeIndex, PhmoShape& out)
{
