...
ModeGeometry System_ModeBuilder::Build(const ModeObject& mode)
{
    ModeGeometry out;
...
void System_ModeBuilder::BuildMarkerGroups(const ModeObject& mode, ModeGeometry& out)
{
...
void System_ModeBuilder::BuildNodes(const ModeObject& mode, ModeGeometry& out)
{
...
void System_ModeBuilder::BuildBounds(const ModeObject& mode, ModeGeometry& out)
{
    ...
    out.BoundsMin = { 
        ci.PositionBoundsX.Min, 
        ci.PositionBoundsY.Min, 
        ci.PositionBoundsZ.Min 
    };

    out.BoundsMax = { 
        ci.PositionBoundsX.Max, 
        ci.PositionBoundsY.Max, 
        ci.PositionBoundsZ.Max 
    };
}

ModeVec3 System_ModeBuilder::MakeVec3(const Vec3& v) 
{ 
    return { v.X, v.Y, v.Z }; 
}

ModeVec4 System_ModeBuilder::MakeVec4(const Vec4& v) 
{ 
