...
SbspGeometry SbspGeometryBuilder::BuildGeometry(const SbspObject& sbsp)
{
    SbspGeometry out;
...
void SbspGeometryBuilder::BuildWorldBounds(const SbspObject& sbsp, SbspGeometry& out)
{
...
void SbspGeometryBuilder::BuildPortals(const SbspObject& sbsp, SbspGeometry& out)
{
...
void SbspGeometryBuilder::BuildClusters(const SbspObject& sbsp, SbspGeometry& out)
{
...
void SbspGeometryBuilder::BuildClusterAdjacency(const SbspObject& sbsp, SbspGeometry& out)
{
...
void SbspGeometryBuilder::BuildInstancedGeometry(const SbspObject& sbsp, SbspGeometry& out)
{
...
void SbspGeometryBuilder::BuildCollisionMaterials(const SbspObject& sbsp, SbspGeometry& out)
{
...
void SbspGeometryBuilder::BuildMarkers(const SbspObject& sbsp, SbspGeometry& out)
{
