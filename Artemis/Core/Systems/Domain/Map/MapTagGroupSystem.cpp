...
void MapTagGroupSystem::LoadForMap()
{
...
void MapTagGroupSystem::Cleanup()
{
    // Hlmt-derived.
...
void MapTagGroupSystem::LoadHlmtFamily(FILE* file, TagGroupReader& reader)
{
...
void MapTagGroupSystem::LoadDirectTags(FILE* file, TagGroupReader& reader)
{
    const int32_t tagCount = (int32_t)g_pState->Domain->Map->GetTagsSize();
