...
WeaponData System_WeapBuilder::Build(const WeapObject& weap)
{
    WeaponData out{};
...
WeaponBarrelData System_WeapBuilder::BuildBarrel(const WeapObject& weap)
{
...
WeaponMagazineData System_WeapBuilder::BuildMagazine(const WeapObject& weap)
{
...
WeaponTriggerData System_WeapBuilder::BuildTrigger(const WeapObject& weap)
{
...
WeaponTargetTrackingData System_WeapBuilder::BuildTargetTracking(const WeapObject& weap)
{
