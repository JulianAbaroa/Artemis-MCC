...
ScnrMapZones System_ScnrBuilder::Build(const ScnrObject& scnr)
{
    ScnrMapZones out{};
...
void System_ScnrBuilder::BuildSpawnPoints(const ScnrObject& scnr, ScnrMapZones& out)
{
...
void System_ScnrBuilder::BuildTriggerVolumes(const ScnrObject& scnr, ScnrMapZones& out)
{
...
void System_ScnrBuilder::BuildNamedLocationVolumes(
...
float System_ScnrBuilder::ExtractYawFromDegree2(uint32_t degree2)
{
    int16_t raw = static_cast<int16_t>(degree2 & 0xFFFF);
    return static_cast<float>(raw) / 32767.0f * 3.14159265f;
}

ScnrTriggerVolume System_ScnrBuilder::BuildTriggerVolume(
