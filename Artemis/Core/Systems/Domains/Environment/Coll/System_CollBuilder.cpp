...
void System_CollBuilder::BuildPathfindingSpheres(const CollObject& coll, CollGeometry& out)
{
...
void System_CollBuilder::BuildNodes(const CollObject& coll, CollGeometry& out)
{
...
CollVec3 System_CollBuilder::MakeVec3(const Vec3& v) { return { v.X, v.Y, v.Z }; }