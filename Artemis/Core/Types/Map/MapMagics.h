...
namespace MapMagics
{
	...
	static constexpr uint32_t k_MachMagic = 0x6D616368;
	static constexpr uint32_t k_ZoneMagic = 0x7A6F6E65;
	static constexpr uint32_t k_SLdTMagic = 0x734C6454;
	static constexpr uint32_t k_LbspMagic = 0x4C627370;
	static constexpr uint32_t k_PlayMagic = 0x706C6179;
}