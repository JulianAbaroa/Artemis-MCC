...
#pragma comment(linker, "/export:WTSActiveSessionExists=C:\\Windows\\System32\\wtsapi32.WTSActiveSessionExists")
#pragma comment(linker, "/export:WTSCloseServer=C:\\Windows\\System32\\wtsapi32.WTSCloseServer")
#pragma comment(linker, "/export:WTSCloudAuthClose=C:\\Windows\\System32\\wtsapi32.WTSCloudAuthClose")
#pragma comment(linker, "/export:WTSCloudAuthConvertAssertionToSerializedUserCredential=C:\\Windows\\System32\\wtsapi32.WTSCloudAuthConvertAssertionToSerializedUserCredential")
#pragma comment(linker, "/export:WTSCloudAuthDuplicateSerializedUserCredential=C:\\Windows\\System32\\wtsapi32.WTSCloudAuthDuplicateSerializedUserCredential")
#pragma comment(linker, "/export:WTSCloudAuthGetServerNonce=C:\\Windows\\System32\\wtsapi32.WTSCloudAuthGetServerNonce")
#pragma comment(linker, "/export:WTSCloudAuthNetworkLogonWithSerializedCredential=C:\\Windows\\System32\\wtsapi32.WTSCloudAuthNetworkLogonWithSerializedCredential")
#pragma comment(linker, "/export:WTSCloudAuthOpen=C:\\Windows\\System32\\wtsapi32.WTSCloudAuthOpen")
