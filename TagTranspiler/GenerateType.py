...
def Generate(xmlPath: str, outPath: str) -> None:
    ...
    lines.append(f"")
    lines.append(f"#include \"Core/Types/Sources/MapReader/MapTypes.h\"")
    lines.append(f"")
